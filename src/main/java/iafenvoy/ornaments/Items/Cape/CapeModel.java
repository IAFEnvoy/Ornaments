...
public class CapeModel<T extends LivingEntity> extends AnimalModel<T> {
  ...
  public CapeModel() {
    textureWidth = 64;
    textureHeight = (Configs.INSTANCE.showoption.getStringValue().equals("s8_7") ? 56 : 64);

    this.cloak = new ModelPart(this);
    this.cloak.setTextureSize(64, (Configs.INSTANCE.showoption.getStringValue().equals("s8_7") ? 56 : 64));
    this.cloak.setTextureOffset(0, 0).addCuboid(-10F, -23.0F, -1.0F, 20F,
        (Configs.INSTANCE.showoption.getStringValue().equals("s8_7") ? 35F : 40F), 1.0F, 0.0F);
  }
