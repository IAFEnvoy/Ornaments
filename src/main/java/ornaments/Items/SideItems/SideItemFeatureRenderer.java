...
public class SideItemFeatureRenderer<T extends LivingEntity, M extends EntityModel<T>> extends FeatureRenderer<T, M> {
  private SideItemModel<T> backItemModel = new SideItemModel<>();

  public SideItemFeatureRenderer(FeatureRendererContext<T, M> context) {
    super(context);
  }
  ...
  public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, T entity, float limbAngle,
    ...
    if (entity instanceof PlayerEntity) {
      Identifier layer = new Identifier(client.MOD_ID, "textures/sideitem/firework_rocket.png");
