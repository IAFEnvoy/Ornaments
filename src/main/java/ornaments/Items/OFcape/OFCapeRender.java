  ...
  public void render(final MatrixStack matrixStack, final VertexConsumerProvider vertexConsumerProvider, final int i,
    ...
    if (abstractClientPlayerEntity.canRenderCapeTexture() && !abstractClientPlayerEntity.isInvisible()
      ...
      if (RenderInfo.ifRender(RenderThings.CAPE, abstractClientPlayerEntity)) {
        ...
        final double e = MathHelper.lerp(h, abstractClientPlayerEntity.prevCapeY, abstractClientPlayerEntity.capeY)
            - MathHelper.lerp(h, abstractClientPlayerEntity.prevY, abstractClientPlayerEntity.getY());
        final double m = MathHelper.lerp(h, abstractClientPlayerEntity.prevCapeZ, abstractClientPlayerEntity.capeZ)
            - MathHelper.lerp(h, abstractClientPlayerEntity.prevZ, abstractClientPlayerEntity.getZ());
        final float n = abstractClientPlayerEntity.prevBodyYaw
        ...
        final float t = MathHelper.lerp(h, abstractClientPlayerEntity.prevStrideDistance,
