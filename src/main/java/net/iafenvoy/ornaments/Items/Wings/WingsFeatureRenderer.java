package net.iafenvoy.ornaments.Items.Wings;

import fi.dy.masa.malilib.util.Color4f;
import net.iafenvoy.ornaments.Client.OrnamentClient;
import net.iafenvoy.ornaments.Config.Configs;
import net.iafenvoy.ornaments.Items.Wings.models.FeatheredWingModel;
import net.iafenvoy.ornaments.Items.Wings.models.LeatherWingModel;
import net.iafenvoy.ornaments.Items.Wings.models.LightWingsModel;
import net.iafenvoy.ornaments.Items.Wings.models.TechWingsModel;
import net.iafenvoy.ornaments.Items.Wings.models.WingEntityModel;
import net.iafenvoy.ornaments.Items.Wings.models.ZanzasWingsModel;
import net.iafenvoy.ornaments.multiplayer.OrnamentsNetwork;
import net.iafenvoy.ornaments.multiplayer.PlayerInfo;
